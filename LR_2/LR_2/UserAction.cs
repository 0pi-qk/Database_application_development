...
namespace lab_2
{
    public class UserAction
    {
            ...
            if(rows > 0)
            {
                ...
                using (var session = NHibernateHelper.OpenSession())
                {
                    ...
                    while (!exit)
                    {
                        ...
                        Console.WriteLine("Страницы: " + pageClients + "/" + maxPage);
                        Console.WriteLine("1) Следующая");
                        Console.WriteLine("2) Предыдущая");
        ...
        public void deleteClients()
        {
            ...
            while (true)
            {
                Console.WriteLine("Введите удаляемый №: ");
        ...
        public void updateClients()
        {
            ...
            while (true)
            {
                Console.WriteLine("Введите изменяемый №: ");
                id = Convert.ToString(Console.ReadLine());
                if (isOnlyInt(id) && Convert.ToInt32(id) > 0 && Convert.ToInt32(id) <= rows)
                {
                    break;
            ...
            while (true)
            {
                ...
                Console.WriteLine("4)Серия паспорта");
                Console.WriteLine("5)Номер паспорта");
                Console.WriteLine("--> ");
            ...
            if(rows > 0)
            {
                ...
                using (var session = NHibernateHelper.OpenSession())
                {
                    ...
                    while (!exit)
                    {
                        ...
                        int maxPage = rows % countObjectOnPage == 0 ? rows / countObjectOnPage : rows / countObjectOnPage + 1;
                        Console.WriteLine("Страницы: " + pageCashiers + "/" + maxPage);
                        Console.WriteLine("1) Следующая");
                        Console.WriteLine("2) Предыдущая");
                        Console.WriteLine("3) Выход");
                        Console.WriteLine("--> ");
        ...
        public void updateCashiers()
        {
            ...
            while (true)
            {
                Console.WriteLine("Введите изменяемый номер: ");
                id = Convert.ToString(Console.ReadLine());
                if (isOnlyInt(id) && Convert.ToInt32(id) > 0 && Convert.ToInt32(id) <= rows)
                {
                    break;
            ...
            Console.WriteLine("Успешно обновлен");
        }
            ...
            if(rows > 0)
            {
                ...
                using (var session = NHibernateHelper.OpenSession())
                {
                    ...
                    while (!exit)
                    {
                        ...
                        int maxPage = rows % countObjectOnPage == 0 ? rows / countObjectOnPage : rows / countObjectOnPage + 1;
                        Console.WriteLine("Страницы: " + pageCurrencies + "/" + maxPage);
                        Console.WriteLine("1) Следующая");
                        Console.WriteLine("2) Предыдущая");
                        Console.WriteLine("3) Выход");
                        Console.WriteLine("--> ");
            ...
            if(rows > 0)
            {
                ...
                using (var session = NHibernateHelper.OpenSession())
                {
                    ...
                    while (!exit)
                    {
                        ...
                        int maxPage = rows % countObjectOnPage == 0 ? rows / countObjectOnPage : rows / countObjectOnPage + 1;
                        Console.WriteLine("Страницы: " + pageRates + "/" + maxPage);
                        Console.WriteLine("1) Следующая");
                        Console.WriteLine("2) Предыдущая");
                        Console.WriteLine("3) Выход");
                        Console.WriteLine("--> ");
        ...
        public void insertRates()
        {
            ...
            while (true)
            {
                Console.WriteLine("Введите номер проданной валюты: ");
            ...
            while (true)
            {
                Console.WriteLine("Введите номер купленной валюты: ");
            ...
            while (true)
            {
                Console.WriteLine("Введите курс продажи: ");
            ...
            while (true)
            {
                Console.WriteLine("Введите курс покупки: ");
        ...
        public void updateRates()
        {
            ...
            while (true)
            {
                Console.WriteLine("1)Номер проданой валюты");
                Console.WriteLine("2)Номер купленой валюты");
                Console.WriteLine("3)Курс продажи");
                Console.WriteLine("4)Курс покупки");
                Console.WriteLine("--> ");
                column = Convert.ToInt32(Console.ReadLine());
            ...
            if (rows > 0)
            {
                ...
                using (var session = NHibernateHelper.OpenSession())
                {
                    ...
                    while (!exit)
                    {
                        ...
                        int maxPage = rows % countObjectOnPage == 0 ? rows / countObjectOnPage : rows / countObjectOnPage + 1;
                        Console.WriteLine("Страницы: " + pageTransactions + "/" + maxPage);
                        Console.WriteLine("1) Следующая");
                        Console.WriteLine("2) Предыдущая");
                        Console.WriteLine("3) Выход");
                        Console.WriteLine("--> ");
        ...
        public void insertTransactions()
        {
            ...
            while (true)
            {
                Console.WriteLine("Введите код кассира: ");
            ...
            while (true)
            {
                Console.WriteLine("Введите код курса продажи: ");
            ...
            while (true)
            {
                Console.WriteLine("Введите код курса покупки: ");
            ...
            {
                Console.WriteLine("Ошибка! Обменный курс не соответствует валюте");
            }
        }
        ...
        public void updateTransactions()
        {
            ...
            while (true)
            {
                Console.WriteLine("1)номер проданной валюты");
                Console.WriteLine("2)номер купленной валюты");
                Console.WriteLine("3)Код клиента");
                Console.WriteLine("4)Код кассира");
                Console.WriteLine("5)Код курса продажи");
                Console.WriteLine("6)код курса покупки");
                Console.WriteLine("7)Дата");
                Console.WriteLine("8)Время");
                Console.WriteLine("9)Сумма продажи");
                Console.WriteLine("10)Сумма покупки");
                Console.WriteLine("--> ");
                column = Convert.ToInt32(Console.ReadLine());
            ...
            {
                Console.WriteLine("Ошибка! Курс обмена не соответствует валюте");
            }
        }
